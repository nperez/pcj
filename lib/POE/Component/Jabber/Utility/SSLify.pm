# Declare our package
package POE::Component::Jabber::Utility::SSLify;
...
BEGIN {
	...
	if ( $@ ) {
		...
		require POE::Component::Jabber::Utility::ClientHandle;
		require POE::Component::Jabber::Utility::ServerHandle;
...
sub Client_SSLify {
	...
	my $newsock = gensym();
	tie( *$newsock, 'POE::Component::Jabber::Utility::ClientHandle', $socket, $version, $options, $ctx ) or die "Unable to tie to our subclass: $!";
...
sub Server_SSLify {
	...
	# Now, we create the new socket and bind it to our subclass of Net::SSLeay::Handle
	my $newsock = gensym();
	tie( *$newsock, 'POE::Component::Jabber::Utility::ServerHandle', $socket, $ctx ) or die "Unable to tie to our subclass: $!";
